...
moduletitle = r'Work order'
componentname = r'WorkOrder'

purpose = r"""work order instance

the work order will group other instances
...
connOutTuples.append(('products', u'Products', 'Product')) # other mul
connOutTuples.append(('contactItems', u'Contact Items', 'ContactItem')) # other mul
connOutTuples.append(('contacts', u'Contacts', 'Contact')) # other mul
connOutTuples.append(('subWorkOrders', u'Sub work orders', 'WorkOrder')) # other mul
connInTuples.append(('mainWorkOrder', u'Main work order', 'WorkOrder'))  # mul 1
...
#additionalClassImports.append('from org.ict_ok.components.work_order.work_order import WorkOrder_WorkOrder_RelManager')
...
additionalClassImports.append('from org.ict_ok.components.product.interfaces import IProduct')
