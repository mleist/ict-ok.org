...
def createUtils(root_folder, connection=None, dummy_db=None):
    ...
    if not "osoftware_oid_index" in instUtilityICatalog.keys():
        osoftware_oid_index = KeywordIndex(interface=ISearchableText,
                                        field_name='getSearchableOperatingSoftwareOid',
                                        field_callable=True)
        instUtilityICatalog['osoftware_oid_index'] = osoftware_oid_index
