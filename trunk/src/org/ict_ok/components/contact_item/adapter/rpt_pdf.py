...
#
"""Adapter implementation for generating pdf reports of ContactItem"""
...
from org.ict_ok.components.contact_item.browser.contact_item import \
    ContactItemDetails
...
class RptPdf(ParentRptPdf):
    """adapter implementation of Contact Item -> PDF Report
    """
