...
#
"""implementation of browser class of Credential"""
...
class CredentialDetails(ComponentDetails):
    """ Class for Credential details
    """
...
class CredentialFolderDetails(ComponentDetails):
