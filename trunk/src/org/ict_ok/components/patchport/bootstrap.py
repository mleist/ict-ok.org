...
def createUtils(root_folder, connection=None, dummy_db=None):
    ...
    if not "patchport_oid_index" in instUtilityICatalog.keys():
        patchport_oid_index = KeywordIndex(interface=ISearchableText,
                                        field_name='getSearchablePatchPortOid',
                                        field_callable=True)
        instUtilityICatalog['patchport_oid_index'] = patchport_oid_index
