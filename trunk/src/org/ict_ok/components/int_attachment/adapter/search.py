...
#
"""Adapter implementation of search-methods for InternalAttachment"""
...
class Searchable(SuperSearchable):
    ...
    def getSearchableInternalAttachmentOid(self):
        """
    ...
    def getFullTextSearchFields(self):
        """
        """
        return InternalAttachment.fullTextSearchFields
