...
def createUtils(root_folder, connection=None, dummy_db=None):
    ...
    if not "room_oid_index" in instUtilityICatalog.keys():
        room_oid_index = KeywordIndex(interface=ISearchableText,
                                        field_name='getSearchableRoomOid',
                                        field_callable=True)
        instUtilityICatalog['room_oid_index'] = room_oid_index
