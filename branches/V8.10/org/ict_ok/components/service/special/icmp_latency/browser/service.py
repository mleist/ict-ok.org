...
from org.ict_ok.components.service.special.icmp_latency.interfaces import \
     IServiceIcmpLatency
from org.ict_ok.components.service.special.icmp_latency.service import \
     Service
...
class MSubAddService(GlobalMenuSubItem):
    """ Menu Item """
    title = _(u'Add ICMP latency check')
    viewURL = 'add_icmp_latency.html'
    weight = 50
...
class AddServiceForm(AddForm):
    ...
    fields = field.Fields(IServiceIcmpLatency).omit(*ServiceDetails.omit_addfields)
    factory = Service
