...
from org.ict_ok.components.misc_physical.interfaces import \
    IMiscPhysical, IAddMiscPhysical, IMiscPhysicalFolder
...
class MGlobalAddMiscPhysical(GlobalMenuAddItem):
    """ Menu Item """
    title = _(u'Add miscellaneous physical component')
    viewURL = 'add_misc_physical.html'
    weight = 50
    folderInterface = IMiscPhysicalFolder
