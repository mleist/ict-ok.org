...
#
"""What to do when upgrade ApplicationSoftware from gen 0 to gen 1"""
...
def evolve(context):
    ...
    for ikobj in findObjectsProviding(root, IApplicationSoftware):
        # convert this object
        evolve_msg = "gen. %d (%s)" % \
                   (generation, evolve.__doc__.strip())
        print "ApplicationSoftware(%s): " % ikobj.ikName + evolve_msg
