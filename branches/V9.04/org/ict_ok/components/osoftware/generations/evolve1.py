...
#
"""What to do when upgrade OperatingSoftware from gen 0 to gen 1"""
...
def evolve(context):
    ...
    for ikobj in findObjectsProviding(root, IOperatingSoftware):
        # convert this object
        evolve_msg = "gen. %d (%s)" % \
                   (generation, evolve.__doc__.strip())
        print "OperatingSoftware(%s): " % ikobj.ikName + evolve_msg
