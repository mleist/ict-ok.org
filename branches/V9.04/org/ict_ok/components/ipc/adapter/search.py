...
#
"""Adapter implementation of search-methods for IndustrialComputer"""
...
class Searchable(SuperSearchable):
    ...
    def getSearchableIndustrialComputerOid(self):
        """
    ...
    def getFullTextSearchFields(self):
        """
        """
        return IndustrialComputer.fullTextSearchFields
