...
logger = logging.getLogger("Compon. Contract")
...
def createUtils(root_folder, connection=None, dummy_db=None):
    ...
    if not "contract_oid_index" in instUtilityICatalog.keys():
        contract_oid_index = KeywordIndex(interface=ISearchableText,
                                        field_name='getSearchableContractOid',
                                        field_callable=True)
        instUtilityICatalog['contract_oid_index'] = contract_oid_index
    ...
    ensureComponentFolderOnBootstrap(IContractFolder,
                 u"Contracts",
                 u'org.ict_ok.components.contract.contract.ContractFolder',
                 root_folder,
                 sitem)
