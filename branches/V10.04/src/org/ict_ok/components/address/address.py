...
from org.ict_ok.components.contact_item.contact_item import ContactItems_Addresses_RelManager
...
class Address(Component):
    ...
    contactItems = RelationPropertyIn(ContactItems_Addresses_RelManager)
